...
<template>
  <SettingsSecurityCourseWrapper name="bank">
    <template v-if="$i18n.locale === 'cn'">
      ...
      <ul class="long-items">
        <li>
          请<strong>安全离线存储</strong>您的密码和助记词。
        </li>
        <li>
          如果您丢失您的密码，那就完全丢失。助记词是您的备份。
        </li>
        <li>
          请随时保持警惕，不要将您的密码或助记词分享给任何人。
          请在浏览网站或者邮件时确保谨慎。
        </li>

        <li>
          建议在您处理账户和转账时，使用VPN如NordVPN，这能加密您的网络连接。
        </li>
      </ul>
    ...
    <template v-else-if="$i18n.locale === 'ru'">
      ...
      <p>
        Означает брать на себя ответственность за вашу цифровую безопасность:
      </p>

      <ul class="long-items">
        <li>
          Будьте умны и <strong> храните </strong> свой пароль и
          мнемоническую фразу <strong> оффлайн в безопасности </strong>.
        </li>
        <li>
          Если вы потеряете свой пароль, он действительно будет потерян.
          Мнемоническая фраза - это ваша резервная копия.
        </li>
        <li>
        ...
        <li>
          Используйте VPN (виртуальную частную сеть), такую как NordVPN,
          при обработке учетных записей и транзакций. Он шифрует весь ваш интернет-трафик.
        </li>
      </ul>

      <h2>Технология Blockchain по своей природе децентрализована</h2>
      <p>
        Это означает, что создатели Base æpp не могут:
      </p>

      <ul class="long-items">
        <li>
          Иметь доступ или замораживать ваш аккаунт
        </li>
        <li>
          Восстанавливать или сбрасывать ваш пароль (это делает мнемоническую фразу очень важной)
        </li>
        <li>
          Изменять, отменять или возвращать транзакции
        </li>
      </ul>
    </template>
    <template v-else>
      ...
      <p>
        Means taking responsibility for your digital security:
      </p>
      ...
      <ul class="long-items">
        ...
        <li>
          Stay sharp and alert. Do not share your password/recovery passphrase with anyone.
          Be aware of phishing websites and emails.
        </li>
      ...
      <p>
        Which means that the makers of Base æpp can not:
      </p>

      <ul class="long-items">
        <li>
          Access or freeze your account
        </li>
        <li>
          Recover or reset your password (this makes the recovery passphrase so important)
        </li>
        <li>
