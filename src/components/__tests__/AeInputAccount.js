...
const testAddressFormatted =
  'ak_ 123 456 789 123 456 789 123 456 789 123 456 789 123 456 789 123 45';
const testAddress51 = 'ak_xXRgaNBuFudv8QHVX52BYmfFyBEZDSWrdMWt2PNk8Mo2ZgHQ';
const testAddress51Formatted =
  'ak_ xXR gaN BuF udv 8QH VX5 2BY mfF yBE ZDS Wrd MWt 2PN k8M o2Z gHQ';
...
describe('AeInputAccount', () => {
  ...
  ].forEach(({ name, backspace }) =>
    it(`removes ${name} value with ${backspace ? 'backspace' : 'delete'} button`, () => {
      const inputListener = jest.fn();
      const wrapper = mountComponent({
