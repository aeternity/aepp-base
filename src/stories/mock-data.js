...
export const transactionHash = 'th_9HqNoJafu4sbTgxZBQf91Xm4xD5Rw6FNSxxrqPTr98TCZW71o';
...
export const fee = BigNumber('26860000000000').shiftedBy(-MAGNITUDE);
export const minFee = BigNumber('16860000000000').shiftedBy(-MAGNITUDE);
